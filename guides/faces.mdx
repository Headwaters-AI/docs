...
```bash
curl https://api.faces.ai/v1/faces \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X PATCH https://api.faces.ai/v1/faces/FACE_ID \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X DELETE https://api.faces.ai/v1/faces/FACE_ID \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X POST https://api.faces.ai/v1/faces/FACE_ID/import-youtube \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
...
```bash
curl -X POST https://api.faces.ai/v1/faces/FACE_ID/transcribe \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -F "file=@podcast.mp3"
```
