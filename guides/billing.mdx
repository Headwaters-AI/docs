...
| Plan | Price | Faces | Compile quota | OAuth routing |
|------|-------|-------|---------------|---------------|
| Free | $0 | Unlimited | Pay-per-token | — |
| Connect | $17/mo | Unlimited | 100,000 tokens / 30 days | OpenAI |

Chat usage (token costs) is billed from your credit balance on all plans.

The **Connect** plan also lets you link your OpenAI account via OAuth, routing interview LLM calls through your own ChatGPT subscription at no additional cost. See [Interview billing source](/guides/compile#interviewer-billing-source) for details.
