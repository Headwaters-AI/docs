...
```bash
# Upload a document
curl -X POST https://api.faces.ai/v1/faces/FACE_ID/upload \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -F "file=@interview.txt" \
  -F "type=document"

# Trigger compilation
curl -X POST https://api.faces.ai/v1/faces/FACE_ID/sync \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl https://api.faces.ai/v1/faces/FACE_ID \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl https://api.faces.ai/v1/faces/FACE_ID/documents \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X DELETE https://api.faces.ai/v1/faces/FACE_ID/documents/DOCUMENT_ID \
  -H "Authorization: Bearer YOUR_API_KEY"
```
